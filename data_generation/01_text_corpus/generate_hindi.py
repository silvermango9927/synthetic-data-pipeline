...
@click.option(
    "--lexicon",
    default="data_generation/01_text_corpus/lexicons/hindi_common.csv",
...
def main(
    ...
    prompt_path = Path(f"data_generation/01_text_corpus/prompts/hindi_{length_target}_system.txt")
